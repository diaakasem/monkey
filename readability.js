...
$(document).ready(function(){
    ...
    var archive = function(){
        if(!$('a.article-archive.active').length && confirm("Do you like to archive the article?")){
            $('a.article-archive').click();
        }
    };
